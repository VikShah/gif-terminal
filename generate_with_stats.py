...
skills = [
    ("\x1b[94mLanguages:\x1b[0m   ", "Java, Python, Go, TypeScript, SQL"),
    ("\x1b[94mBackend:\x1b[0m     ", "Spring Boot, Apache Camel, Flask"),
    ("\x1b[94mFrontend:\x1b[0m    ", "React, Next.js, Node.js"),
    ("\x1b[94mCloud:\x1b[0m       ", "AWS, Azure, GCP"),
    ("\x1b[94mData:\x1b[0m        ", "PostgreSQL, MySQL, Firebase"),
    ("\x1b[94mDevOps:\x1b[0m      ", "Docker, Azure DevOps, CI/CD"),
    ("\x1b[94mConcepts:\x1b[0m    ", "Microservices, Event-Driven APIs"),
]
